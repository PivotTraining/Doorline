...
const SheetRow = memo(function SheetRow({ id, idx, street, nh, rl, dm, bid, d, ni, customer, phone, comments, cb, onSet, onRemove }) {
  ...
  return (
    <tr>
      ...
      <td><input className="input" style={{ padding: "6px 8px" }} type="tel" value={phone} placeholder="phone → nudge" onChange={(e) => onSet(id, { phone: e.target.value })} /></td>
    ...
    <>
      ...
      <div className="card" style={{ overflowX: "auto" }}>
        <table className="tbl" style={{ minWidth: 760 }}>
          ...
          <tbody>
            {rows.length === 0 && (
              <tr><td colSpan={SHEET_COLS.length + 6} className="muted" style={{ padding: 16 }}>No doors yet — tap “Add door” to start the street.</td></tr>
            )}
            {rows.map((r, i) => (
