  ...
  return (
    <>
      ...
      <div className="card" style={{ marginTop: 14 }}>
        ...
        <p className="muted" style={{ marginTop: 0, fontSize: 13 }}>
          Campaigns now have their own page — full breakdowns, promos, and a personalized enrollment
          link per rep. Manage them under <b>Campaigns</b> in the sidebar. The campaign names there are
          also exactly what reps pick from when they close a deal.
        </p>
      </div>
